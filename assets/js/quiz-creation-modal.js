...
var displayQuestion = function (questionObj) {
  ...
  questionDivEl.className = "col s6 offset-s3"
  ...
  answerYesButtonEl.className = "waves-effect waves-light btn-large center-align"
  ...
  answerNoButtonEl.className = "waves-effect waves-light btn-large center-align"
